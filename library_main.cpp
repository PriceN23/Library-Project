...
void list_of_titles(const library *archive, int num_books) {
	...
	std::cout << std::endl << "Titles are case and space sensitive, enter 1 to return to menu";
	std::cout << std::endl << "Enter title of book to print all informaiton on that title: ";
...
void reshelf_book(library *archive, int num_books) {
	...
	std::cout << std::endl << "Titles are case and space sensitive, enter 1 to return to menu";
	std::cout << std::endl << "Enter title of book to return: ";
...
void menu_selection(int selected, library *archive, int num_books, const std::string *authors, int num_authors) {
	switch (selected) {
	case 1:
